...
BIN = Path(__file__).resolve().parent.parent / "scripts" / "cardinal-install-site"
...
class InstallSiteTests(unittest.TestCase):
    ...
    def test_add_lakerunner_sends_managed_poc_and_persists_reservation_key(self):
        ...
        installs = json.loads((self.home / ".cursor" / "cardinal-installs.json").read_text())
    ...
    def test_reservation_file_unreadable_does_not_clobber_other_sites(self):
        ...
        installs = self.home / ".cursor" / "cardinal-installs.json"
